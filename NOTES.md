...
The [README](./README.md) gets you running. This is everything else: how the app is put together,
what to change when you make it yours, and how the consents gate works underneath.
